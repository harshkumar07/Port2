...
import { ArrowDownRight, ArrowUpRight, Download, FileText, Mail, MapPin, Sparkles, Terminal, Gamepad2, ExternalLink, Cloud } from 'lucide-react';
import { SiDotnet, SiReact, SiPython, SiJavascript, SiTypescript, SiPostgresql, SiMysql, SiNodedotjs, SiMongodb, SiGit, SiGithub, SiOkta, SiDocker, SiNextdotjs, SiTailwindcss } from '@icons-pack/react-simple-icons';
